...
namespace Browser.AvaloniaApplication;
...
internal class OtherTheme : ITheme
{
    ...
    public ThemeColor HoverBackgroundColor => new( Colors.PaleGoldenrod.A, Colors.PaleGoldenrod.R, Colors.PaleGoldenrod.G, Colors.PaleGoldenrod.B );

    public ThemeColor HoverForegroundColor => ThemeColors.Black;

    public ThemeColor HoverHeaderBackgroundColor => new( Colors.Goldenrod.A , Colors.Goldenrod.R , Colors.Goldenrod.G , Colors.Goldenrod.B );
