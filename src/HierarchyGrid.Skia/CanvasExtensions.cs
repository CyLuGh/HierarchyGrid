...
namespace HierarchyGrid.Skia
{
    internal static class CanvasExtensions
    {
        ...
        )
        {
            ...
            var columnsVerticalSpan = viewModel
                .ColumnsHeadersHeight.Take(viewModel.ColumnsHeadersHeight.Length - 1)
                .Sum();
            var rowsHorizontalSpan = viewModel
                .RowsHeadersWidth.Take(viewModel.RowsHeadersWidth.Length - 1)
                .Sum();

            canvas.DrawGlobalHeader(
                viewModel,
        ...
        private static void DrawGlobalHeader(
            this SKCanvas canvas,
            HierarchyGridViewModel viewModel,
            IList<(ElementCoordinates, Guid)> previousGlobalCoordinates,
            SkiaTheme theme,
        ...
        )
        {
            ...
            var isHovered = previousGlobalCoordinates
                .Find(t => rect.IntersectsWith(t.Item1.ToRectangle()))
            ...
            paint.Color = isHovered
                ? theme.HoverHeaderBackgroundColor
        ...
        private static void DrawParentColumnHeader(
            ...
            HierarchyGridViewModel viewModel,
            SkiaTheme theme,
            HierarchyDefinition src,
            HierarchyDefinition origin,
            int column,
        ...
        internal static void DrawRowHeaders(
            this SKCanvas canvas,
            HierarchyGridViewModel viewModel,
            SkiaTheme theme,
            Func<HierarchyGridViewModel, HierarchyDefinition[]> selector,
        ...
        private static void DrawParentRowHeader(
            this SKCanvas canvas,
            HierarchyGridViewModel viewModel,
            SkiaTheme theme,
            HierarchyDefinition src,
        ...
        )
        {
            ...
            if (
                cell.ResultSet.Qualifier == Qualification.Empty
                && !cell.HasSpecialRenderStatus(viewModel)
            )
            {
